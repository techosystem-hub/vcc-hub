...
const CURATED: Omit<VCCEvent, 'id'>[] = [
  ...
  { title: 'VivaTech 2026', date: '2026-05-22', endDate: '2026-05-24', location: 'Paris, France', url: 'https://vivatechnology.com', source: 'VivaTech', description: "Europe's biggest startup & tech event.", type: 'conference', tags: ['europe','startup','vc'] },
  ...
  { title: 'EIC Accelerator — Application Deadline', date: '2026-06-03', location: 'Online (EU)', url: 'https://eic.ec.europa.eu', source: 'EIC', description: 'EU grants & equity for deep tech. Up to EUR 17.5M per startup.', type: 'deadline', tags: ['eu','grant','deeptech'] },
  ...
  { title: 'SaaStr Annual 2026', date: '2026-09-09', endDate: '2026-09-11', location: 'San Francisco, USA', url: 'https://saastrannual.com', source: 'SaaStr', description: "World's largest SaaS community. 10,000+ founders & investors.", type: 'conference', tags: ['saas','usa','vc'] },
  { title: 'IT Arena 2026', date: '2026-10-02', endDate: '2026-10-04', location: 'Lviv, Ukraine', url: 'https://itarena.ua', source: 'IT Arena', description: "Ukraine's largest tech conference. 5,000+ attendees.", type: 'conference', tags: ['ukraine','lviv'] },
  { title: 'TC Disrupt 2026', date: '2026-10-06', endDate: '2026-10-08', location: 'San Francisco, USA', url: 'https://techcrunch.com/events/tc-disrupt', source: 'TechCrunch', description: "TechCrunch's flagship startup & investor conference.", type: 'conference', tags: ['usa','startup','vc'] },
  { title: 'Web Summit 2026', date: '2026-11-02', endDate: '2026-11-05', location: 'Lisbon, Portugal', url: 'https://websummit.com', source: 'Web Summit', description: "World's largest tech conference. Strong CEE/Ukraine startup presence.", type: 'conference', tags: ['global','startup','networking'] },
  { title: 'Slush 2026', date: '2026-11-19', endDate: '2026-11-20', location: 'Helsinki, Finland', url: 'https://slush.org', source: 'Slush', description: 'World-leading startup & investor event. Strong CEE/UA startup track.', type: 'conference', tags: ['europe','startup','vc'] },
]
